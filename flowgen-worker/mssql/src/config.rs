...
/// Type alias for query processor configuration.
pub type QueryProcessor = MssqlQuery;
...
mod tests {
    ...
    fn test_deserialize_mssql_query() {
        ...
        let config: MssqlQuery = serde_yaml::from_str(yaml).unwrap();
